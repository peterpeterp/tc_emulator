...
class wind_estimator(object):
    ...
    def get_analogue_pdfs(self, coordinates = {'sst':np.arange(26,30.2,0.2).round(2), 'wind_before':np.arange(10,180,10), 'wind_change_before':np.arange(-30,35,10), 'wind':np.arange(10,180,10)}, atl):
        '''
        self = wind_obj
        coordinates = {'sst':np.arange(26,30.2,0.2).round(2), 'weather_0':np.arange(0,20,1), 'wind_before':np.arange(10,180,10), 'wind_change_before':np.arange(-30,35,10), 'wind':np.arange(10,180,10)}

        plot_combis = [(15,30,10),(16,30,10),(0,30,10),(15,60,10),(16,60,10),(0,60,10),(15,100,10),(16,100,10),(0,100,10)]
        plot_ssts = [26.,27.,28.,29.,30.]
        '''
